        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2 mt-6">
              <input type="radio" id="byDateCreated" name="dateFilter" defaultChecked />
              <label htmlFor="byDateCreated">By Date Created</label>
              <input type="radio" id="byAppointmentDate" name="dateFilter" />
              <label htmlFor="byAppointmentDate">By Appointment Date</label>
            </div>
          </div>
